...
export default function Login() {
  ...
  // ✅ Save user data directly from login response
    ...
    <>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .signup-row a { color: #f0c27a; text-decoration: none; font-weight: 500; margin-left: 4px; }
      ...
      <div className="login-root">
        ...
        <div className="right-panel">
          ...
          <div className="login-subheading">Sign in to continue exploring the world's most beautiful destinations.</div>
